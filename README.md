...
ไม่ได้อยู่ภายใต้ Apache License ครอบคลุมทั้ง `roadmap/`, `content/toeic-media/`,
`evals/` และบทเรียนกับข้อสอบที่ฝังอยู่ใน `SeedData.cs` ผู้ที่นำโค้ดไปใช้ต่อ
ต้องจัดหาเนื้อหาหลักสูตรของตนเอง
